...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.CompleteWaveResponse();
  });
  ...
  describe('CompleteWaveResponse', function() {
    it('should create an instance of CompleteWaveResponse', function() {
      // uncomment below and update the code to test CompleteWaveResponse
      //var instane = new Inventory.CompleteWaveResponse();
      //expect(instance).to.be.a(Inventory.CompleteWaveResponse);
    });
