...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.ProductMatch();
  });
  ...
  describe('ProductMatch', function() {
    it('should create an instance of ProductMatch', function() {
      // uncomment below and update the code to test ProductMatch
      //var instane = new Inventory.ProductMatch();
      //expect(instance).to.be.a(Inventory.ProductMatch);
    });
