...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.CreateExportSettingsS3Request();
  });
  ...
  describe('CreateExportSettingsS3Request', function() {
    it('should create an instance of CreateExportSettingsS3Request', function() {
      // uncomment below and update the code to test CreateExportSettingsS3Request
      //var instane = new Inventory.CreateExportSettingsS3Request();
      //expect(instance).to.be.a(Inventory.CreateExportSettingsS3Request);
    });
