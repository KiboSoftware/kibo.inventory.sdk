...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.ExportSettingsS3();
  });
  ...
  describe('ExportSettingsS3', function() {
    it('should create an instance of ExportSettingsS3', function() {
      // uncomment below and update the code to test ExportSettingsS3
      //var instane = new Inventory.ExportSettingsS3();
      //expect(instance).to.be.a(Inventory.ExportSettingsS3);
    });
