...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.AdjustItem();
  });
  ...
  describe('AdjustItem', function() {
    it('should create an instance of AdjustItem', function() {
      // uncomment below and update the code to test AdjustItem
      //var instane = new Inventory.AdjustItem();
      //expect(instance).to.be.a(Inventory.AdjustItem);
    });
