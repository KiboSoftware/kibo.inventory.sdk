...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.FetchFileConfigRequest();
  });
  ...
  describe('FetchFileConfigRequest', function() {
    it('should create an instance of FetchFileConfigRequest', function() {
      // uncomment below and update the code to test FetchFileConfigRequest
      //var instane = new Inventory.FetchFileConfigRequest();
      //expect(instance).to.be.a(Inventory.FetchFileConfigRequest);
    });
    ...
    it('should have the property testFTPConfigs (base name: "testFTPConfigs")', function() {
      // uncomment below and update the code to test the property testFTPConfigs
      //var instane = new Inventory.FetchFileConfigRequest();
      //expect(instance).to.be();
    });
