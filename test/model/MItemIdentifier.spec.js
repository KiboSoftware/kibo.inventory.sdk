...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.MItemIdentifier();
  });
  ...
  describe('MItemIdentifier', function() {
    it('should create an instance of MItemIdentifier', function() {
      // uncomment below and update the code to test MItemIdentifier
      //var instane = new Inventory.MItemIdentifier();
      //expect(instance).to.be.a(Inventory.MItemIdentifier);
    });
