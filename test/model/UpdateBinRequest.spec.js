...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inventory.UpdateBinRequest();
  });
  ...
  describe('UpdateBinRequest', function() {
    it('should create an instance of UpdateBinRequest', function() {
      // uncomment below and update the code to test UpdateBinRequest
      //var instane = new Inventory.UpdateBinRequest();
      //expect(instance).to.be.a(Inventory.UpdateBinRequest);
    });
